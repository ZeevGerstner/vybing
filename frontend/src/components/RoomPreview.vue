<template>
  <div class="room-item">
    <router-link class="room-item-link" tag="div" :to="'/room/'+room._id">
      ...
      <div class="room-details">
        ...
        <div class="room-icon room-item-icon">
          <img class="icon-img room-item-img" src="../assets/imgs/LISTENERS-ICON.png">
          <h4 class="icon-count room-item-count">{{room.members.length}}</h4>
        </div>

        <div class="room-icon room-item-icon">
          <img class="icon-img room-item-img" src="../assets/imgs/EAR-ICON.png">
    ...
    <h3 v-if="room.playlist.length > 1">{{room.playlist[0].title}}</h3>
